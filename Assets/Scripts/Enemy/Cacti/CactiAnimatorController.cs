using Sistemata.Enemy.Cacti;
using Sistemata.Player;
using UnityEngine;

namespace Sistemata.Enemy
{
    public class CactiAnimatorController :  MonoBehaviour
    {
        ...
        private CactiController _enemyController;
        ...
        private void Start()
        {
            ...
            _enemyController = GetComponent<CactiController>();
        }
